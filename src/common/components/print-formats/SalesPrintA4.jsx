...
import classes from "@assets/css/SalesPrintA4.module.css";
import { useTranslation } from "react-i18next";

export default function SalesPrintA4({ salesViewData, setPrintA4, salesItems, configData }) {
                ...
                <Stack justify="center" gap={0}>
                  <Flex justify="flex-end" mt="0">
                    <Text fw="600" fz="16" mr="sm">
                      {configData?.company_name || configData?.domain?.company_name}
                    </Text>
                  </Flex>
                  <Stack justify="flex-end" gap={0} mt="4">
                    <Group justify="flex-start" gap={0}>
                      ...
                      <p className={classes[ "invoice-text" ]}>
                        {configData?.email || configData?.domain?.email}
                      </p>
                    </Group>
                    <Group justify="flex-start" gap={0}>
                      <p className={classes[ "invoice-text-title" ]}>
                      ...
                      <p className={classes[ "invoice-text" ]}>:</p>
                      <p className={classes[ "invoice-text" ]}>
                        {configData?.mobile || configData?.domain?.mobile}
                      </p>
                    </Group>
                  </Stack>
                </Stack>
