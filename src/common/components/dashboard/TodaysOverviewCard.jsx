...
export default function TodaysOverviewCard({ dailyData }) {
        ...
        <Paper shadow="sm" p="lg" radius="md" withBorder>
            ...
            <Stack gap="md">
                ...
                <MetricCard
                    ...
                    value={`৳ ${dailyData.totalInvoices > 0
                        ? (dailyData.totalSales / dailyData.totalInvoices).toFixed(2)
                        : '0.00'}`}
                ...
                <MetricCard
                    ...
                    value={`৳ ${dailyData.totalInvoices > 0
                        ? (dailyData.totalDiscount / dailyData.totalInvoices).toFixed(2)
                        : '0.00'}`}
                ...
                <MetricCard
                    ...
                    value={dailyData.topProducts.length > 0
                        ? dailyData.topProducts[ 0 ].name
                        : t("NA")}
                    icon={<IconReceipt size={20} />}
                    color="teal"
                    subValue={dailyData.topProducts.length > 0
                        ? `${dailyData.topProducts[ 0 ].totalQuantity} ${t("UnitsSold")}`
                        : null}
                />
            </Stack>
        </Paper>
