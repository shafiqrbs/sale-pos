...
import { useChangePasswordMutation } from "@services/core/core";
						...
						<Box className="borderRadiusAll">
							<ScrollArea h={mainAreaHeight - 50} scrollbarSize={2} scrollbars="y" type="never">
								...
								<Box mt="md">
									<PasswordInputForm
										tooltip={
											form.errors.new_password ? form.errors.new_password : t("RequiredPassword")
										}
										form={form}
										name="new_password"
										label={t("NewPassword")}
